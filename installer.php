...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221116_exemplo_crud_6e57afbb63b746262485_20221116174820_archive.zip';
        const ARCHIVE_SIZE       = '20420644';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6e57afb-16174820';
        const SECONDARY_PACKAGE_HASH = '7b3ea73-16174820';
        const VERSION            = '1.5.0';
